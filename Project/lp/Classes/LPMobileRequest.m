...
#define kMethodhead_image_api @"head_image_api.php"
...
+ (void)head_image_apiWithParameters: (id)parameters success:(void (^)(AFHTTPRequestOperation *operation, id responseObject))success failure:(void (^)(AFHTTPRequestOperation *operation, NSError *error))failure
{
    [self Request:kMethodhead_image_api WithPost:NO WithParameters:parameters success:success failure:failure];
}
